        ...
        <>
            <section className="flex w-full flex-wrap items-center justify-between">
                    ...
                    <form >
                        ...
                        <div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                            ...
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-5 mt-5">
                                <input className="w-full col-span-2 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                            ...
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-6 mt-5">
                               
                                <input className="w-full col-start-2 col-span-2 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              ...
              focus:outline-none focus:shadow-outline">
                        ...
                        <div
                            className="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-yellow-500 rounded-2xl">
                            <div className="flex flex-col text-white">
                                <h1 className="font-bold text-neutral-900 uppercase text-4xl my-4">Encantados de atenderte</h1>
                                <p className="text-neutral-100">Nuestra principal especialidad es cocinar, pero la segunda es tratar a los clientes como si estubiesen en casa. <br />
